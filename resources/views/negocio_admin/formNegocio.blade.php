...
<div class="form-group">
    ...
    <input type="url" class="form-control" name="facebook" value="{{ isset($negocio->facebook)?$negocio->facebook:old('facebook') }}" id="facebook"><br>
</div>
...
<label for="nota" style="color: black; font-weight: bold;">NOTA: Los campos con * son obligatorios</label>
<br><br>
    <input class="btn btn-success" type="submit" value="{{ $modo }} negocio">
